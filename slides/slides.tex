...
\only<1>{\begin{tikzpicture}[remember picture,overlay]\node[xshift=1.4cm,yshift=3.4cm] at (current page.south west) {$\hookrightarrow$};\end{tikzpicture}}
\only<2>{\begin{tikzpicture}[remember picture,overlay]\node[xshift=1.4cm,yshift=1.8cm] at (current page.south west) {$\hookrightarrow$};\end{tikzpicture}}
...
\ifANIMATE
	\only<1>{\begin{tikzpicture}[remember picture,overlay]\node[xshift=1.4cm,yshift=3.45cm] at (current page.south west) {$\hookrightarrow$};\end{tikzpicture}}
	\only<2>{\begin{tikzpicture}[remember picture,overlay]\node[xshift=1.4cm,yshift=3cm] at (current page.south west) {$\hookrightarrow$};\end{tikzpicture}}
	\only<3>{\begin{tikzpicture}[remember picture,overlay]\node[xshift=1.4cm,yshift=3cm] at (current page.south west) {$\hookrightarrow$};\end{tikzpicture}}
	\only<4>{\begin{tikzpicture}[remember picture,overlay]\node[xshift=1.4cm,yshift=1.6cm] at (current page.south west) {$\hookrightarrow$};\end{tikzpicture}}
	\only<5>{\begin{tikzpicture}[remember picture,overlay]\node[xshift=1.4cm,yshift=1.6cm] at (current page.south west) {$\hookrightarrow$};\end{tikzpicture}}	
	\only<6->{\begin{tikzpicture}[remember picture,overlay]\node[xshift=1.4cm,yshift=0.3cm] at (current page.south west) {$\hookrightarrow$};\end{tikzpicture}}
\fi
...
\vspace{0.6cm}
\begin{center} \noindent\makebox[\linewidth]{\line(2,0){500}} \end{center} \vspace{-0.5cm}
\begin{minted}[mathescape=true,escapeinside=||,tabsize=4,fontsize=\footnotesize,]{c}
    |$\ldots$|
	git checkout master
\end{minted}
...
\ifANIMATE
	\only<1-3>{\begin{tikzpicture}[remember picture,overlay]\node[xshift=1.4cm,yshift=2.9cm] at (current page.south west) {$\hookrightarrow$};\end{tikzpicture}}
%	\only<2>{\begin{tikzpicture}[remember picture,overlay]\node[xshift=1.4cm,yshift=2.7cm] at (current page.south west) {$\hookrightarrow$};\end{tikzpicture}}
\fi
\pause
%\pause
\PAUSE
...
\ifANIMATE
%	\only<3>{\begin{tikzpicture}[remember picture,overlay]\node[xshift=1.4cm,yshift=2.7cm] at (current page.south west) {$\hookrightarrow$};\end{tikzpicture}}
	\only<4->{\begin{tikzpicture}[remember picture,overlay]\node[xshift=1.4cm,yshift=0.9cm] at (current page.south west) {$\hookrightarrow$};\end{tikzpicture}}
\fi
\end{frame}
...
%\only<1>{\begin{tikzpicture}[remember picture,overlay]\node[xshift=1.4cm,yshift=1.7cm] at (current page.south west) {$\hookrightarrow$};\end{tikzpicture}}
%\pause
...
\only<1>{\begin{tikzpicture}[remember picture,overlay]\node[xshift=1.4cm,yshift=1.3cm] at (current page.south west) {$\hookrightarrow$};\end{tikzpicture}}

\pause
%\begin{minted}[mathescape=true,escapeinside=||,tabsize=4,fontsize=\footnotesize,]{c}
%	git merge master
%\end{minted}
\only<2>{\begin{tikzpicture}[remember picture,overlay]\node[xshift=1.4cm,yshift=0.7cm] at (current page.south west) {$\hookrightarrow$};\end{tikzpicture}}
\end{frame}
...
\only<1>{\begin{tikzpicture}[remember picture,overlay]\node[xshift=1.4cm,yshift=2.05cm] at (current page.south west) {$\hookrightarrow$};\end{tikzpicture}}

\pause[2]
\only<2>{\begin{tikzpicture}[remember picture,overlay]\node[xshift=1.4cm,yshift=1.55cm] at (current page.south west) {$\hookrightarrow$};\end{tikzpicture}}
\pause
\only<3->{\begin{tikzpicture}[remember picture,overlay]\node[xshift=1.4cm,yshift=1cm] at (current page.south west) {$\hookrightarrow$};\end{tikzpicture}}
\end{frame}
...
numbersep=5pt,bgcolor=mintedbackground,
]{bash}
git init .
git add .
...
%			Workflow \textit{(édité à la main)}
			...
			\begin{adjustwidth}{-0cm}{-3cm}{}
				\begin{figure}
					\hfill
					\includegraphics[scale=0.18]{images/centralized_workflow.png}
				\end{figure}
			\end{adjustwidth}
		\end{column}%
	\end{columns}
...
\vspace{-1em}
\begin{minted}[mathescape=true,escapeinside=**,tabsize=4,fontsize=\footnotesize,breaklines,numbersep=5pt,bgcolor=mintedbackground,]{c}
	git diff
	git add <fichiers>
...
%\textit{\texttt{while (je travaille = vrai) }} %$\{$}}
\vspace{-1em}
\begin{minted}[mathescape=true,escapeinside=**,tabsize=4,fontsize=\small,breaklines,numbersep=5pt,bgcolor=mintedbackground,]{c}
	git status
