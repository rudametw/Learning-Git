...
\begin{itemize}
\item Se connecter sur votre projet dans GitLab \url{https://gitlab.univ-lille.fr/<login>/<projet.git>}
...
\item une fois résolu, mergez vos changements et poussez vers le serveur
